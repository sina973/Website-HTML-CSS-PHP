...
<section class="container">
    ...
    <section class="content">
        ...
        <h1>به روز رسانی اطلاعات مربوط به news با شناسه <?php echo $id ?></h1>
        <a class="showDetails" href="<?php echo DOMAIN ?>/administrator/admin/show_details_news.php">نمایش همه ی اطلاعات</a>
        <section class="form">
