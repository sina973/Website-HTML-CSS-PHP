...
<section class="container">
    ...
    <section class="content">
        ...
        <h1>ثبت اطلاعات مربوط به news</h1>
        <a class="showDetails" href="<?php echo DOMAIN ?>/administrator/admin/show_details_news.php">نمایش جزییات</a>
        <section class="form">
            <form action="news/insert.php" method="post" enctype="multipart/form-data">
                <input type="text" name="title" placeholder="please enter a title for your news">

                <textarea name="text" placeholder="please enter your news text"></textarea>
