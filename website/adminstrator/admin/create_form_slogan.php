...
<section class="container">
    ...
    <section class="content">
        ...
        <h1>ثبت اطلاعات مربوط به slogan</h1>
        <a class="showDetails" href="<?php echo DOMAIN ?>/administrator/admin/show_details_slogan.php">نمایش جزییات</a>
        <section class="form">
            <form action="slogan/insert.php" method="post" enctype="multipart/form-data">
                <input type="text" name="title" placeholder="please enter a title for your slogan">

                <textarea name="summary" placeholder="please enter your slogan summary"></textarea>
